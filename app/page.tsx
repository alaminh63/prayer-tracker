...
import { IslamicKnowledgeCard } from "@/components/islamic-knowledge-card"
            ...
            <section aria-label="Today's prayer times" className="flex flex-col gap-6">
              <div className="flex items-center justify-between px-4">
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-muted-foreground font-bold uppercase tracking-widest text-[10px]">Current schedule for your location</p>
                </div>
